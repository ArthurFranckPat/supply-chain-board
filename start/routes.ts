...
router
  .group(() => {
    ...
    router
      .get(
        '/api/v1/planning/material-plan/detail',
    ...
    router
      .get(
        '/api/v1/heures-produites/orders-detail',
        '#controllers/produced_hours_controller.ordersDetail'
      )
      .as('heures_produites.orders_detail')
