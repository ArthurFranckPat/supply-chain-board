 ...
 * inertia/pages/suivi.tsx (axe allocation / expédition).
 *
...
import { EMPTY, PROACTIVE_EMPTY, PROACTIVE_COLUMNS, REACTIVE_COLUMNS, fmtMs, suiviRowKey, type SuiviColumnMeta } from '@r/lib/suivi/shared'
...
import { ReactiveView } from '@r/components/suivi/reactive-view'
import { ProactiveView } from '@r/components/suivi/proactive-view'
import { SuiviDetailSheet } from '@r/components/suivi/suivi-detail-sheet'
