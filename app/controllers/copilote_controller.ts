...
export default class CopiloteController {
  ...
  /**
   * GET /api/v1/copilote/health — prouve provider + présence clé (sans LLM).
   */
  ...
  /**
   * GET /api/v1/copilote/metrics — télémétrie des tours (mémoire, fenêtre glissante).
   *
  ...
  /**
   * POST /api/v1/copilote/chat — tour conversationnel SSE.
   */
  ...
  /**
   * GET /api/v1/copilote/conversations — liste de l'historique de l'user (sidebar).
   */
  ...
  /**
   * GET /api/v1/copilote/conversations/:id — messages d'une conversation (rechargement).
   */
  ...
  /**
   * DELETE /api/v1/copilote/conversations/:id — supprime une conversation.
   */
  ...
  /**
   * PATCH /api/v1/copilote/conversations/:id — renomme une conversation.
