...
import { Button, buttonVariants } from "@r/components/ui/button"
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        /* Grammaire calendrier (airbnb-composants.html §09) : jour = disque
           (cellules carrées en pilule), plage en surface plate. */
        "group/calendar bg-background p-2 [--cell-radius:9999px] [--cell-size:--spacing(7)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
