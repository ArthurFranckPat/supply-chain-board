...
- **Fichier** : `apps/ordo-core/production_planning/services/x3_client.py:96`
...
- **Fichiers** : `apps/ordo-core/production_planning/api/x3_routes.py:96` + `apps/ordo-core/production_planning/services/stock_history_analyzer.py:107`
...
- **Fichier** : `apps/ordo-core/production_planning/api/server.py:338-347`
...
- **Fichier** : `apps/ordo-core/production_planning/services/stock_history_analyzer.py:213-237`
...
- **Fichier** : `apps/ordo-core/production_planning/api/server.py:104-108`
...
- **Fichier** : `apps/ordo-core/production_planning/api/server.py:117-121`
...
- **Fichier** : `apps/ordo-core/production_planning/api/x3_routes.py:55-56`
