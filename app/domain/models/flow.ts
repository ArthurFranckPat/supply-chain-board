...
export type FlowOrigin =
  ...
  | { type: 'order'; id: string; customer: string; pays: string | null; orderType: OrderType | null; nature: NeedNature; contremarque: string | null; qteCommandee: number; qteAllouee: number; ligne?: string | null; designation?: string | null }
