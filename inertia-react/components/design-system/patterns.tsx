...
const MIGRATION: { nom: string; etat: 'cursor' | 'partiel' | 'airbnb'; reste: string }[] = [
  ...
  { nom: 'Select', etat: 'partiel', reste: 'panneau et items' },
  {
    nom: 'Badge',
    etat: 'airbnb',
    reste: 'tons sémantiques à retarger sur --success/--warn/--danger',
  },
  { nom: 'Pill', etat: 'airbnb', reste: 'hauteurs et rayon plein' },
  ...
  { nom: 'Combobox', etat: 'airbnb', reste: 'panneau, chips, items' },
