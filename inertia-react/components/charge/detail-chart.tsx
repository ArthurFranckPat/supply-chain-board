...
import { type Gran, type ChargeSegOption, segmentDeCle, satRate, total } from '@r/lib/charge/chart-math'
import { fenetreMoyenneMobile } from '@r/lib/charge/moyenne-mobile'
      ...
      items.map((it, i) => ({
        ...
        valeurs: Object.fromEntries(
          segments.map((s) => {
            ...
            return [k, k in it.d ? it.d[k as keyof ChargePeriod] : 0]
          })
        ),
