...
### RecursiveChecker (src/checkers/recursive.py)
...
### AllocationManager (src/algorithms/allocation.py)
...
**Fichier** : `src/checkers/recursive.py`
...
**Fichier** : `src/algorithms/allocation.py`
