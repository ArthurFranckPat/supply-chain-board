...
class AllocationResult:
    ...
    allocated_quantity : dict[str, float]
    ...
    allocated_quantity: dict[str, float] = None
...
class StockState:
    ...
    allocated_stock : dict[str, float]
    ...
    def __init__(self, initial_stock: dict[str, float]):
        ...
        self.allocated_stock: dict[str, float] = {}

    def get_available(self, article: str) -> float:
    ...
    def allocate(self, of_num: str, allocations: dict[str, float]):
    ...
    def add_supply(self, article: str, quantity: float):
...
class AllocationManager:
    ...
    def _get_initial_stock(self) -> dict[str, float]:
    ...
    def _calculate_allocations(self, of: OF, stock_state: StockState) -> dict[str, float]:
