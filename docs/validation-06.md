...
| 10 | K2992 | **achat direct** | CG2600496:10512* | 2027-05-03 | 2026-08-06 | 366 520 | Gros stock mais MRPDAT lointain (05/27) — grille large, pas de pénurie courte attendue (**cas limite**, voir écarts) | — | 5 j |
...
- 9/10 `MRPDAT_0` **peuplés** (V1) et 9/10 pénuries attendues **≤ MRPDAT** (dont 3 `déjà en retard`). Le 10ᵉ (K2992, MRPDAT 05/27 horizon long) est un **faux négatif attendu** : stock massif, pénurie au-delà de l'horizon 90 j — la grille hybride la verrait en hebdo, mais le bucket 18 mois n'est pas rejoué ici.
...
|---|---|---|
| ≥ 8/10 grilles montrent pénurie avant MRPDAT_0 | 9/10 attendues ≤ MRPDAT (1 hors horizon lointain K2992, documenté) | **✔ go** |
...
3. **K2992 horizon lointain** — `MRPDAT_0=2027-05-03`, grille 90 j + hebdo : pénurie potentiellement au-delà de l'horizon quotidien (21 j) et noyée dans l'hebdo. Le critère `pénurie ≤ MRPDAT` tient, mais la lecture `premierePenurie` pourra rendre `null` si le besoin est > 90 j + stock massif — prévu par `buildGrille(... horizonDays=90)` et non un bug.
