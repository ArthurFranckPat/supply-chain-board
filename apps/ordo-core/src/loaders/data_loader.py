...
class DataLoader:
    """DataLoader principal - Interface de requete pour les donnees."""
    ...
    def __init__(self, data_dir: str = None, *, csv_loader: "CSVLoader" = None):
        ...
        data_dir : str, optional
            Chemin vers le repertoire d'extractions ERP.
        csv_loader : CSVLoader, optional
            Loader pre-configure (utilise par ``from_extractions``).
        """
    ...
    def get_ofs_by_origin(self, num_ordre_origine: str, article: Optional[str] = None) -> list[OF]:
        """Retourne les OF liés à une commande d'origine."""
