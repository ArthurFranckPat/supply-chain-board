...
export const badgeVariants = cva({
  ...
  variants: {
    variant: {
      ...
      success: 'border-transparent bg-emerald-500/15 text-emerald-700 [a&]:hover:bg-emerald-500/25',
      warning: 'border-transparent bg-amber-500/15 text-amber-700 [a&]:hover:bg-amber-500/25',
    },
  },
  defaultVariants: {
    variant: 'default',
