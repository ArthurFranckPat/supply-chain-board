...
- Creer un service dedie (ex: `EolResidualsService`) dans `apps/production-planning/production_planning/feasibility/eol_residuals.py`.
...
3. Exposition API production-planning
- Ajouter endpoint POST dans `apps/production-planning/production_planning/api/server.py`, ex: `/api/v1/eol-residuals/analyze`.
- Ajouter facade dans `apps/production-planning/production_planning/app/gui_service.py` (verif data chargee, appel service, serialisation standard).
