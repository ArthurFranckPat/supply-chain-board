...
- **Fichier** : `apps/ordo-core/planning_engine/services/x3_client.py:96`
...
- **Fichiers** : `apps/ordo-core/planning_engine/api/x3_routes.py:96` + `apps/ordo-core/planning_engine/services/stock_history_analyzer.py:107`
...
- **Fichier** : `apps/ordo-core/planning_engine/api/server.py:338-347`
...
- **Fichier** : `apps/ordo-core/planning_engine/services/stock_history_analyzer.py:213-237`
...
- **Fichier** : `apps/ordo-core/planning_engine/api/server.py:104-108`
...
- **Fichier** : `apps/ordo-core/planning_engine/api/server.py:117-121`
...
- **Fichier** : `apps/ordo-core/planning_engine/api/x3_routes.py:55-56`
