 ...
 * « Charge par ligne »). Émis par ChargeController.index, consommé par
...
export type ChargeView = 'of' | 'commande'
 ...
 *              reste à faire ? ».
 */
export type ChargeQtyMode = 'brut' | 'net' | 'reste'

export interface ChargePageProps {
