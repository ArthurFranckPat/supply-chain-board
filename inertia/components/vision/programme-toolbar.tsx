 ...
 *
 *  Ces constantes sont la SOURCE UNIQUE de la grammaire toolbar : elles sont
 *  exportées pour que les segments/pills injectés dans la rangée contexte
 *  (Liens, Rail… cf. programme.tsx) réutilisent exactement les mêmes valeurs
 *  au lieu de recopier des classes à la main (dérives px-2.5 / min-h-[28px]). */
