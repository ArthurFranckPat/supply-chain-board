 ...
 *
 * Les lignes arrivent déjà filtrées du parent (ruptures) ; le tri
...
import { isLate, VERDICT_TONE } from '@r/lib/ruptures/rupture-math'

export function RuptureRegistre({
  rows,
  onSelectOf,
  emptyState,
}: {
  ...
  const columns: ColumnDef<RuptureDisplayRow>[] = [
    {
...
export default RuptureRegistre
