      ...
      >
              ...
              fallback={
                <div class="flex flex-1 flex-col items-center justify-center gap-2 p-10 text-destructive">
                  ...
                  <span class="text-sm font-medium">
                    Échec du chargement de l'engagement.
                  </span>
                </div>
              }
            >
        ...
        >
          {(d) => {
            ...
            const weeksEngaged = () =>
              d().weeklyCapacityHours ? Math.round((d().totalHours / d().weeklyCapacityHours) * 10) / 10 : null
            return (
            <>
              ...
              <div class="flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-border bg-secondary px-5 py-3 pr-14">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex items-baseline gap-1">
                    ...
                    <span class="font-mono text-[10px] font-semibold text-muted-foreground">h</span>
                ...
                <div class="flex-1 overflow-auto">
                  ...
                  <For each={d().rows}>
                    {(r, i) => {
                      ...
                      const prevU = () => (i() > 0 ? urgencyOf(d().rows[i() - 1].livraisonIso) : null)
                            ...
                            <div class="min-w-0">
                              ...
                              >
                                <For each={r.commandes}>
                                  {(c) => (
                                    <div class="min-w-0">
                                      <div class="flex items-center gap-1.5 overflow-hidden" title={`${c.numCommande}${c.ligne ? `·L${c.ligne}` : ''}${c.client ? ` — ${c.client}` : ''}`}>
