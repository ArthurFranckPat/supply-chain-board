 ...
 * inertia/components/of/of-affermir-action.tsx (issue #52) : bouton fixe +
...
export interface OfAffermirActionProps {
  firming: boolean
...
export function OfAffermirAction(props: OfAffermirActionProps) {
  return (
...
export default OfAffermirAction
