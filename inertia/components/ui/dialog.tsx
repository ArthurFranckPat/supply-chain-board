...
export const DialogHeader = (props: DialogHeaderProps) => {
  ...
  return (
    <div data-slot="dialog-header" class={cx("flex flex-col gap-2 text-center sm:text-left", props.class)} {...rest} />
  )
}
...
export const DialogFooter = (props: DialogFooterProps) => {
  const [, rest] = splitProps(props, ["class"])
  return (
    <div data-slot="dialog-footer" class={cx("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", props.class)} {...rest} />
  )
}
...
export const DialogTitle = <T extends ValidComponent = "h2">(props: DialogTitleProps<T>) => {
  ...
  return <DialogPrimitive.Title data-slot="dialog-title" class={cx("text-lg leading-none font-semibold", props.class)} {...rest} />
}

export type DialogDescriptionProps<T extends ValidComponent = "p"> = ComponentProps<typeof DialogPrimitive.Description<T>>

export const DialogDescription = <T extends ValidComponent = "p">(props: DialogDescriptionProps<T>) => {
  const [, rest] = splitProps(props as DialogDescriptionProps, ["class"])
  return <DialogPrimitive.Description data-slot="dialog-description" class={cx("text-muted-foreground text-sm", props.class)} {...rest} />
}
