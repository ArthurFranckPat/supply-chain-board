...
export function formatTriggerDate(date: CalendarDate) {
  // ADAPTATION PROJET (BoardUI livre ici un Intl "4 sept. 2026") : ce board
  // affiche TOUTES ses dates en jj/mm/aaaa, sans exception — c'est la même
  // convention que les en-têtes de périodes, le drawer « appelé par » et le
  // reste du produit. On réutilise donc le format du chip d'édition, qui est
  // déjà celui-là : trigger et champ de saisie lisent pareil.
  return formatChipDate(date);
}
