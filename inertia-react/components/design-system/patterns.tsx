  ...
  return (
    ...
    >
      <Fiche
        ...
        etat="cursor"
        note="Carte « Listing » : la bande de statut en wash plat du ton (succès/alerte/danger) porte la réf. article et tient lieu de photo, le n° d'OF est l'ancre, la charge se lit au pied. Badge de faisabilité au coin."
      >
        <div
