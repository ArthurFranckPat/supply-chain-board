...
import { X3DebugView } from '@/views/X3DebugView'
...
import { TrendingUp, Factory, Zap, PanelLeftClose, PanelLeftOpen, AlertTriangle, ShoppingCart, CheckCircle, PackageSearch, Settings, Database, Activity, LayoutDashboard, Wrench, CalendarDays, FileText, Package } from 'lucide-react'
...
const NAV_ITEMS: Array<{ key: ViewKey; label: string; icon: React.ReactNode }> = [
  ...
  { key: 'x3-debug', label: 'X3 Debug', icon: <Database className="h-[15px] w-[15px]" /> },
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          {activeView === 'x3-debug' && <X3DebugView />}
          {activeView === 'reports' && (
            <ReportsView
