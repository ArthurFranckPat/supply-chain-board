...
export interface SuiviTableShellProps<TRow> {
...
export function SuiviTableShell<TRow>(props: SuiviTableShellProps<TRow>) {
 ...
 */
function TrackingEmptyState<TRow>(props: SuiviTableShellProps<TRow>) {
