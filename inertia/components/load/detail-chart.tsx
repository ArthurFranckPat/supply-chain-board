  ...
  return (
    <div ref={wrapEl} class="relative min-h-0 flex-1" onMouseMove={onMove}>
      ...
      >
        ...
        {/* Pic */}
        <Show when={geom().peak}>
          {(pk) => <circle cx={pk().cx} cy={pk().cy} r="4" fill={BRAND} />}
        </Show>
      </svg>
        ...
        {(h) => (
          ...
          >
            ...
            <div class="mt-1 flex items-center gap-2">
              ...
              <span class="ml-3 font-fraunces text-[15px] font-extrabold tabular-nums">
                {h().value} h
              </span>
            </div>
            ...
            <Show when={h().total > 0}>
              ...
              <Show when={h().cap > 0}>
                <div
                  ...
                  style={{ color: satColor(h().total, h().cap) }}
                >
